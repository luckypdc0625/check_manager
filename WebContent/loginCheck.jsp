...
<body bgcolor="#ECF1F5">
	...
	int loginResult = userDAO.userCheck(userId, userPassword);
	if(userId == "") {
		%>
	아이디를 입력해주세요.<br/>
	...
	%>
	<%=(String) session.getAttribute("userName") %>님 환영합니다.<br/>
	...
	%>
	비밀번호가 다릅니다.<br/>
	<a href="javascript:window.history.go(-1);"><img src="img/이전으로.png"title="logo" width="160" height="40" ></a>
	<%
	} else if(loginResult == -1) {
	%>
	아이디가 존재하지 않습니다.<br/>
...
<footer class="footer">
    <fot1 class="fot1">
        <img src="img/키보드.png"title="logo" width="70" height="80" ><br><br/>
    </fot1>
