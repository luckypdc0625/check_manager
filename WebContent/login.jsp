...
<body bgcolor="#ECF1F5">
	...
	<form class="context" action="loginCheck.jsp">
	아이디 : <input type="text" name="userId"><br/>
	비밀번호 : <input type="password" name="userPassword">
	<input type="submit" value="" style="width:80px; height:30px; background-image: url('img/로그인.png'); background-size:100% 100%; background-repeat: no-repeat;">
	</form>
