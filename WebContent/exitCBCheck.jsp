...
<a href="javascript:window.history.back()"><img src="img/이전으로.png"title="logo" width="160" height="40" ></a>
			...
			clipboardDAO.exit(cbid, (String) session.getAttribute("userName"));
			%>
<div class="context">
<%=nominee %>님께 매니저를 위임하고 <%=cbname%> 클립보드에서 퇴장하셨습니다.<br/>
