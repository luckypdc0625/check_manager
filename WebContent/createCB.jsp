...
<body bgcolor="#ECF1F5">
    ...
    <section>
	<form class="context" action="createCBCheck.jsp">
	클립보드 이름 : <input type="text" name="cbName"><br/>
	초대할 사람 닉네임 : <input type="text" name="involvedWithoutMe"><br/>
	※ 닉네임은 ',' 단위로 공백 없이 입력해주세요. :)<br/>
	<input type="submit" value="" style="width:170px; height:40px; background-image: url('img/클립보드생성.png'); background-size:100%; background-repeat: no-repeat;">
	</form>
